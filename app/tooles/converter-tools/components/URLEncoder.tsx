...
export default function URLEncoder() {
  ...
  const handleProcess = () => {
    try {
      ...
      setOutput("Error: Invalid URI encoding format.");
    }
  };
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold text-slate-800 flex items-center gap-2">
        <Link2 className="w-6 h-6 text-primary-theme" />
        URL Encoder / Decoder
      </h2>
      <p className="text-sm text-slate-500 mt-1">
        Encode regular text to safe URL-compliant string or decode URL strings back.
      </p>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col">
          ...
          <textarea
            ...
            placeholder={
              mode === "encode"
                ? "Enter parameters or string to encode..."
